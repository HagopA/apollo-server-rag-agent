...
The system automatically recognizes anime and routes it to Sonarr (which manages both TV shows and anime), which then uses anime-specific quality profiles and file handling.
...
Anime is fetched in **1080p balanced quality**, the same as regular TV shows. The quality profiles are maintained by Profilarr to ensure the best available version is always selected.
...
Sonarr monitors anime series for new episodes automatically. If episodes are missing, it could be because:
- The episodes haven't been released yet
- A good quality release hasn't been found yet — the system will keep searching
- There was a download issue — Cleanuparr may be handling it automatically
